...
class Product
{
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $erpCreateDate = null;
    ...
    public function getErpCreateDate(): ?\DateTimeInterface
    {
        return $this->erpCreateDate;
    }

    public function setErpCreateDate(?\DateTimeInterface $erpCreateDate): static
    {
